...
function speak(text,rate){ if(!window.speechSynthesis||!text) return; speechSynthesis.cancel(); const u=new SpeechSynthesisUtterance(String(text).replace(/[＿_]+/g,"")); u.lang="ja-JP"; const v=jaVoice(); if(v) u.voice=v; u.rate=rate||0.85; speechSynthesis.speak(u); }
